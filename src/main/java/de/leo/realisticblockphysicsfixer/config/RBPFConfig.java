...
public final class RBPFConfig {
    ...
    static {
        ...
        MAX_QUEUED_EXPLOSION_RECORDS = builder.comment("Max delayed explosion records waiting for merge/planning.")
                .defineInRange("maxQueuedExplosionRecords", 50, 1, 1000);
        ...
        WHITELIST_MODE = builder.comment(
                "False = blacklist mode. True = only blocks in blockWhitelist can be targeted."
        ...
        BLOCK_WHITELIST = builder.comment("Only used when whitelistMode=true.")
