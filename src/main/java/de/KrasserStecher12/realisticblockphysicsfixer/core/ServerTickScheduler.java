...
public final class ServerTickScheduler {
    ...
    public void onRegisterCommands(RegisterCommandsEvent event) {
        if (de.KrasserStecher12.realisticblockphysicsfixer.config.RBPFConfig.COMMAND_ENABLED.get()) {
            de.KrasserStecher12.realisticblockphysicsfixer.command.RBPFCommand.register(event.getDispatcher(), registry);
        }
    }
